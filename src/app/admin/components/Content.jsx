...
function Content({totalUsersData, totalPostsData}) {
    return (
        <div className='px-10 rounded-lg'>
            ...
            <p>
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Id recusandae illo necessitatibus dolore, nobis rem aliquid distinctio aut et. Recusandae nam quae facere sit quis qui esse fugit assumenda harum!
            </p>
        </div>
    )
}
